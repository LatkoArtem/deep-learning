...
Для захисту є `lab2.ipynb`. Він використовує збережені прогнози, показує таблиці, графіки та помилки. Щоб навчити модель прямо з notebook, розкоментуй два рядки в секції навчання; прогнози буде записано в `notebook_results` і підставлено в наступні клітинки. Запуск з цієї теки:
